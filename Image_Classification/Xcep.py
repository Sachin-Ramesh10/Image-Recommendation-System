...
nb_classes = 135  # number of classes
...
def plot_training(history):
    ...
    print(epochs,loss,acc,val_loss,val_acc)
...
if __name__ == '__main__':
    if not len(sys.argv) == 3:
        ...
        validation_dir = os.path.join(os.path.abspath(data_dir), 'Cross_Validation')  # each class should have it's own folder
